...
namespace FunBooksAndVideos.Infrastructure.Migrations
{
    ...
    [Migration("20240212091839_removed enttity")]
    partial class removedenttity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FunBooksAndVideos.Domain.Models.ItemLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FunBooksAndVideos.Domain.Models.Membership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FunBooksAndVideos.Domain.Models.PurchaseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FunBooksAndVideos.Domain.Entities.Customer", b =>
                {
                    b.HasOne("FunBooksAndVideos.Domain.Models.Membership", "Membership")
                        .WithMany()
            ...
            modelBuilder.Entity("FunBooksAndVideos.Domain.Models.ItemLine", b =>
                {
                    b.HasOne("FunBooksAndVideos.Domain.Models.PurchaseOrder", "PurchaseOrder")
                        .WithMany("ItemLines")
